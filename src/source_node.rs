...
impl SourceNode {
    pub fn new(position: Option<(usize, usize)>,
        source: Option<StringPtr>, name: Option<StringPtr>) -> SourceNode {
    ...
    pub fn to_string_with_source_map(&self, file: Option<StringPtr>, source_root: Option<StringPtr>) -> StringWithSrcMap {
...
impl ToSourceMapContext {
    pub fn new(file: Option<Rc<String>>, source_root: Option<Rc<String>>, skip_validation: bool) -> ToSourceMapContext {
        ToSourceMapContext {
...
impl WalkFunction for ToSourceMapContext {
    fn process_chunk(&mut self, chunk: &Rc<String>, original_source: &Option<Rc<String>>,
    ...
    fn process_source_content(&mut self, source: &Rc<String>, source_content: &Rc<String>) {
        self.map.set_source_content(source.clone(), Some(source_content.clone()));
    }
}

trait WalkFunction {
    fn process_chunk(&mut self, chunk: &Rc<String>, original_source: &Option<Rc<String>>,
        original_position: &Option<(usize, usize)>, original_name: &Option<Rc<String>>);
    fn process_source_content(&mut self, source: &Rc<String>, source_content: &Rc<String>);
}
